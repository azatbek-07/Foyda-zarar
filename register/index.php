...
<body class="bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <div
                class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full mb-4 shadow-lg">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            <form id="registerForm" action="" method="post" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <div class="flex space-x-1">
                            <div id="strengthBar1"
                                class="h-1 flex-1 bg-gray-200 rounded-full transition-all duration-300"></div>
                            <div id="strengthBar2"
                                class="h-1 flex-1 bg-gray-200 rounded-full transition-all duration-300"></div>
                            <div id="strengthBar3"
                                class="h-1 flex-1 bg-gray-200 rounded-full transition-all duration-300"></div>
                ...
                <div class="flex items-center">
                    ...
                    <label for="terms" class="ml-2 block text-sm text-gray-700">
                        Men <a href="#" class="text-purple-600 hover:text-purple-500">shartlar</a> va <a href="#"
                            class="text-purple-600 hover:text-purple-500">maxfiylik siyosati</a>ga roziman
                    </label>
                </div>
            ...
            <div class="text-center">
                <p class="text-gray-600">
                    Hisobingiz bormi?
                    <a href="../login/"
                        class="text-purple-600 hover:text-purple-700 font-semibold transition duration-200 ease-in-out">
                        Kirish
                    </a>
                </p>
            </div>
