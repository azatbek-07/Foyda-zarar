                ...
                <?php foreach ($products as $index => $product): ?>
                    <div class="card-hover bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden transition-all duration-300 slide-up" 
                        ...
                        <div class="border-t border-gray-100 p-4 flex gap-2">
                            ...
                            <button onclick="window.location.href='delete_product.php'" class="flex items-center justify-center gap-2 bg-red-50 text-red-700 px-4 py-2.5 rounded-xl font-medium hover:bg-red-100 transition-all duration-200">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
